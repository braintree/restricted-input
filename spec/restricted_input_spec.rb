...
describe 'Restricted Input' do
  ...
  describe 'for number' do
    ...
    it 'pre-formats on initialization' do
      input = @driver.find_element(:id, 'prefilled-credit-card-number')
      expect(input[:value]).to eql('4111 1111 1111 1111')
    end
  end
  ...
  describe 'for unformatted' do
    it 'enters a credit card' do
      input = @driver.find_element(:id, 'credit-card-unformatted')
      input.send_keys '4111111111111111'
  ...
  describe 'for toggle-able' do
    it 'toggles' do
      input = @driver.find_element(:id, 'credit-card-toggle-able')
      button = @driver.find_element(:id, 'credit-card-toggle-able-btn')
  ...
  describe 'wildcard' do
    it 'accepts digits' do
      input = @driver.find_element(:id, 'wildcard')
