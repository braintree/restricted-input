...
var OldAndroidChromeBasedWebviewStrategy = require('./strategies/old-android-chrome-based-webview');
...
function RestrictedInput(options) {
  ...
  } else if (device.isOldAndroidChromeBasedWebview()) {
    this.strategy = new OldAndroidChromeBasedWebviewStrategy(options);
